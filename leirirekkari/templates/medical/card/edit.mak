		...
		<div class="ten columns">
			<form method="POST" action="">
            			...
            			<div class="row">
        					<div class="six columns">
        					    <fieldset>
                					...
                					<label>${_(u"Notes")}<br />
    						        <textarea name="additional_notes">${helpers.decodeString(medicalParticipantAdditional.notes)}</textarea></label>
    						    </fieldset>
        					</div>
        					<div class="six columns">
        					    <fieldset>
				...
				<fieldset>
                    ...
                    <div id="medical_card_events_container">
				    % for medicalCardEvent in medicalCardEvents:
				    <div class="medical_event">
				        <input type="hidden" name="event_id" value="${medicalCardEvent.id}">
                        <div class="row">
                            <div class="four columns">
                                <label>${_(u"Time")}<br />
        						<input type="text" name="event_time" class="datetimepicker" value="${helpers.modDateTime(medicalCardEvent.event_time)}" /></label>
                            </div>
                            <div class="four columns">
                                <label>${_(u"Writer")}<br />
        						<input type="text" name="event_writer" value="${helpers.decodeString(medicalCardEvent.writer)}" /></label>
                            </div>
                            <div class="four columns">
                        ...
                        <div class="row">
                            <div class="ten columns">
                                <label>${_(u"Notes")}<br />
						        <textarea name="event_notes">${helpers.decodeString(medicalCardEvent.notes)}</textarea></label>
                            </div>
                            <div class="two columns">
    							<div class="remove_medical_card_event_row_container" style="float:left; margin-left: 10px;">
    								<br /><a href="#" class="remove_medical_card_event_row">${_(u"Remove event")}</a>
    							</div>
                            </div>
                        </div>
                    </div>
					...
					<div id="medical_event_null" style="display: none;">
                        <div class="medical_event" id="medical_card_event_null_row">
    				        <input type="hidden" name="event_id" value="0">
                            <div class="row">
                                <div class="four columns">
                                    <label>${_(u"Time")}<br />
            						<input type="text" name="event_time" class="event_time_datetimepicker" value="" /></label>
                                </div>
                                <div class="four columns">
                                    <label>${_(u"Writer")}<br />
            						<input type="text" name="event_writer" value="" /></label>
                                </div>
                                <div class="four columns">
                                    <label>${_(u"Type")}</label>
                                    <select name="event_type">
                            ...
                            <div class="row">
                                <div class="ten columns">
                                    <label>${_(u"Notes")}<br />
    						        <textarea name="event_notes"></textarea></label>
                                </div>
                                <div class="two columns">
        							<div class="remove_medical_card_event_row_container" style="float:left; margin-left: 10px;">
        								<br /><a href="#" class="remove_medical_card_event_row">${_(u"Remove event")}</a>
					...
					<a href="#" id="add_medical_event_row">${_(u"Add event")}</a>
				</fieldset>
				<fieldset>
