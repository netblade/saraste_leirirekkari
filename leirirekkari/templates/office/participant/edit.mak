                ...
                <fieldset>
                    ...
                    <div class="row">
                        <div class="six columns">
                            ...
                            <label>
                                ${_(u"Birthdate")}<br />
                                <input type="text" class="datepicker" name="birthdate" value="${helpers.modDate(participant.birthdate)}" />
                            </label>
                            <label>
                                ${_(u"Designation")}<br />
                            ...
                            <label>
                                ...
                                <select name="age_group">
                                    ...
                                    % if participant.age_group == 4:
                                        <option selected="selected" value="4">${_(u"Tracker")}</option>
                                    % else:
                                        <option value="4">${_(u"Tracker")}</option>
                                    % endif
                                ...
                                % if len(participant.phone_data) > 0:
                                    ...
                                    <div class="phone_row">
                                        <fieldset>
                                            ...
                                            <input type="hidden" name="phone_id" value="${phone_data.id}" />
                                            <label>
                                                ${_(u"Number")}<br />
                        ...
                        <fieldset>
                            ...
                            % if len(participant.language_data) > 0:
                                ...
                                <div class="language_skill_row">
                                    <input type="hidden" name="language_id" value="${language_data.id}" />
                                    <div class="clearer"></div>
                                    <label>
                                        ${_(u"Language")}<br />
                            ...
                            % if len(participant.presence_data) > 0:
                                ...
                                <div class="presence_row">
                                    <fieldset>
                                        ...
                                        <input type="hidden" name="presence_id" value="${presence_data.id}" />
                                        <div class="clearer"></div>
                                        <label>
                                            ${_(u"Starts")}<br />
                                            <input class="presence_starts" type="text" name="presence_starts" value="${helpers.modDateTime(presence_data.presence_starts)}" />
                                        </label>
                                        <label>
                                            ${_(u"Ends")}<br />
                                            <input class="presence_ends" type="text" name="presence_ends" value="${helpers.modDateTime(presence_data.presence_ends)}" />
                                        </label>
                        ...
                        <fieldset>
                            ...
                            % if len(participant.meta_data) > 0:
                                ...
                                <div class="metadata_row">
                                    <fieldset>
                                        <input type="hidden" name="metadata_id" value="${meta_data.id}" />
                            ...
                            <div id="metadata_row_null" style="display: none;">
                                <div class="metadata_row" id="metadata_row_null_row">
                                    <fieldset>
                                        <input type="hidden" name="metadata_id" value="0" />
                                        ...
                                        <label>
                                            ${_(u"Value")}<br />
                                            <textarea class="meta_value" name="meta_value"></textarea>
                                        </label>
                                    </fieldset>
                                </div>
                                <div class="clearer"></div>
