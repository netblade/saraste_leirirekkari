		...
		<div class="ten columns">
			<form method="POST" action="">
				<fieldset>
					...
					<label>
						${_(u"Starts")}<br />
						<input type="text" name="starts" class="datepicker" value="${helpers.decodeString(shift.starts)}" />
					</label>
					<label>
						${_(u"Ends")}<br />
						<input type="text" name="ends" class="datepicker" value="${helpers.decodeString(shift.ends)}" />
					</label>
					<label>
						${_(u"Notes")}<br />
